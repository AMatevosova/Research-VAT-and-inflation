...
filename_w <- paste0("weights_output_усечённая_32_лага.xlsx", t_treat, "_prod_all.xlsx")
...
significance_df <- synth_obj %>% 
  grab_significance()
filename_sign <- paste0("significance__усечённая_32_лага", t_treat, "_prod_all.xlsx")
...
filename_sign <- paste0("res_усечённая_32_лага", t_treat, "_prod_all.xlsx")
