...
data <- subset(data, select = -c(`Говядина (кроме бескостного мяса), кг`))
data
...
filename_w <- paste0("weights_output_усечённая_32_лага_2017_", t_treat, ".xlsx")
...
significance_df <- synth_obj %>% 
  grab_significance()
filename_sign <- paste0("significance__усечённая_32_лага_2017_", t_treat, ".xlsx")
...
filename_sign <- paste0("res_усечённая_32_лага_2017_", t_treat, "_all.xlsx")
